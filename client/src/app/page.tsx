  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div className="block sm:hidden text-center mb-8">
          ...
          <form action={async () => {
            ...
            <Button
              type="submit"
              size="lg"
              className="bg-[#5865F2] hover:bg-[#4752C4] text-white w-full max-w-xs px-6 py-3"
            >
        ...
        {/* Mobile Status Cards */}
        <div className="block sm:hidden grid grid-cols-2 gap-3 mb-8">
          <Card className="p-3">
            <div className="text-center">
              <Activity className={`h-5 w-5 mx-auto mb-1 ${stats.isOnline ? 'text-green-600' : 'text-red-600'}`} />
              <div className={`text-lg font-bold ${stats.isOnline ? 'text-green-600' : 'text-red-600'}`}>
                {stats.isOnline ? '온라인' : '오프라인'}
              </div>
              <p className="text-xs text-muted-foreground">봇 상태</p>
            </div>
          </Card>
          <Card className="p-3">
            <div className="text-center">
              <Server className="h-5 w-5 text-muted-foreground mx-auto mb-1" />
              <div className="text-lg font-bold">{stats.guildCount}</div>
              <p className="text-xs text-muted-foreground">연결된 서버</p>
            </div>
          </Card>
          <Card className="p-3">
            <div className="text-center">
        ...
        <div className="block sm:hidden">
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">🤖 봇 명령어</CardTitle>
