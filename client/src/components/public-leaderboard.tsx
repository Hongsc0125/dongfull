...
import { Trophy, Crown, Medal, Target, Clock, Zap, Star, Calendar, Users, BarChart3, Sparkles } from "lucide-react"
...
export function PublicLeaderboard({ event, leaderboard, stats }: PublicLeaderboardProps) {
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="text-center mt-16 space-y-6">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20">
            ...
            <span className="text-white/80 text-sm">실시간 자동 업데이트</span>
          </div>
